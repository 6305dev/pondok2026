        ...
        <div class="p-2 fade-in-card">
            <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-500 ease-out border-2 border-transparent hover:shadow-xl hover:scale-[1.02] hover:border-blue-500 cursor-pointer h-full">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Pengajuan akta perkawinan bagi Non Muslim</p>
                    <div class="flex space-x-2">
                        @guest
                            <button type="button"
                                onclick="event.preventDefault(); event.stopPropagation(); showPanduanRich(
        ...
        <div class="p-2 fade-in-card">
            <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-500 ease-out border-2 border-transparent hover:shadow-xl hover:scale-[1.02] hover:border-blue-500 cursor-pointer h-full">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Pengajuan akta perceraian bagi Non Muslim</p>
                    <div class="flex space-x-2">
                        @guest
                            <button type="button"
                                onclick="event.preventDefault(); event.stopPropagation(); showPanduanRich(
...
function showPanduanRich(judul, htmlIsi, urlLanjutkan, urlLogin = '/login', urlDaftar = '/register') {
    ...
    Swal.fire({
        title: `<div class="flex items-center justify-center space-x-2 text-gray-800 font-bold text-lg">${meta.icon} <span>Informasi ${meta.judul}</span></div>`,
        html: `
            <div class="text-left text-sm text-gray-600 leading-relaxed p-4 bg-gray-50 rounded-2xl border border-gray-100 max-h-[50vh] overflow-y-auto mb-4">
                ${meta.deskripsi}
            </div>
            <div class='bg-gray-100 py-4 px-4 sm:px-4 rounded-xl border border-gray-200'>
                <div class='flex justify-between gap-2'>
                    <button type='button' class='btn-masuk flex-1 px-4 py-2 h-10 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 focus:outline-none transition-colors'>Masuk</button>
                    <button type='button' class='btn-daftar flex-1 px-4 py-2 h-10 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none transition-colors'>Daftar</button>
                </div>
            </div>
        `,
