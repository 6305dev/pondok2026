        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="bg-white border-b border-gray-100 p-6 sm:p-5">
                <div class="flex flex-col sm:flex-row items-stretch w-full overflow-hidden border rounded-xl bg-gray-50">
                    <div class="relative flex-1 flex items-center py-3 pl-6 pr-4 transition-all"
                        :class="currentStep === 1 ? 'bg-blue-600 text-white' : (currentStep > 1 ? 'bg-white text-blue-600' : 'bg-white text-gray-400')"
                        class="sm:[clip-path:polygon(0%_0%,_95%_0%,_100%_50%,_95%_100%,_0%_100%)]">
                        <div class="flex items-center space-x-3">
                            <div :class="currentStep > 1 ? 'bg-blue-600 text-white border-blue-600' : (currentStep === 1 ? 'bg-white text-blue-600 border-white' : 'border-gray-300')" 
                                class="w-7 h-7 border-2 rounded-full flex items-center justify-center font-bold text-xs flex-shrink-0 transition-colors">
                                <template x-if="currentStep > 1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg></template>
                    ...
                    <div class="relative flex-1 flex items-center py-3 pl-6 pr-4 transition-all"
                        :class="currentStep === 2 ? 'bg-blue-600 text-white' : (currentStep > 2 ? 'bg-white text-blue-600' : 'bg-white text-gray-400')"
                        class="sm:[clip-path:polygon(95%_0%,_100%_50%,_95%_100%,_0%_100%,_5%_50%,_0%_0%)]">
                        <div class="flex items-center space-x-3">
                            <div :class="currentStep > 2 ? 'bg-blue-600 text-white border-blue-600' : (currentStep === 2 ? 'bg-white text-blue-600 border-white' : 'border-gray-300')" 
                                class="w-7 h-7 border-2 rounded-full flex items-center justify-center font-bold text-xs flex-shrink-0 transition-colors">
                                <template x-if="currentStep > 2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg></template>
                    ...
                    <div class="relative flex-1 flex items-center py-3 pl-6 pr-4 transition-all"
                        :class="currentStep === 3 ? 'bg-blue-600 text-white' : (currentStep > 3 ? 'bg-white text-blue-600' : 'bg-white text-gray-400')"
                        class="sm:[clip-path:polygon(95%_0%,_100%_50%,_95%_100%,_0%_100%,_5%_50%,_0%_0%)]">
                        <div class="flex items-center space-x-3">
                            <div :class="currentStep > 3 ? 'bg-blue-600 text-white border-blue-600' : (currentStep === 3 ? 'bg-white text-blue-600 border-white' : 'border-gray-300')" 
                                class="w-7 h-7 border-2 rounded-full flex items-center justify-center font-bold text-xs flex-shrink-0 transition-colors">
                                <template x-if="currentStep > 3"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg></template>
            ...
            <div class="p-6 sm:p-5">
                <div x-show="currentStep === 1" x-transition.opacity>
                    <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
                        <h3 class="text-red-800 font-bold mb-1">Perhatian !!</h3>
                ...
                <div x-show="currentStep === 2" x-transition class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input type="text" x-model="formData.nik" @input="formData.nik = $event.target.value.replace(/[^0-9]/g, '')" maxlength="16" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition shadow-sm" placeholder="16 digit NIK">
                            <p x-show="errors.nik" x-text="errors.nik" class="text-[11px] text-red-500 italic font-bold"></p>
                            <p class="text-[11px] text-gray-500 italic text-left text-transform-none" style="text-transform: none;">* Silahkan ubah NIK jika anda mengajukan anggota lain, dan atau isi NIK Anda jika anak belum mempunyai NIK (baru lahir).</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-bold text-gray-700">Nomor Kartu Keluarga <span class="text-red-500">*</span></label>
                            <input type="text" x-model="formData.kk" readonly class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 bg-gray-100 outline-none transition shadow-sm cursor-not-allowed" placeholder="16 digit KK">
                            <p x-show="errors.kk" x-text="errors.kk" class="text-[11px] text-red-500 italic font-bold"></p>
                            <p class="text-[11px] text-gray-500 italic text-left text-transform-none" style="text-transform: none;">* Anda hanya dapat mengajukan untuk anggota keluarga dalam 1 KK.</p>
                        </div>

                        <div class="space-y-1">
                            <label class="text-sm font-bold text-gray-700">Nama Lengkap <span class="text-red-500">*</span></label>
                            <input type="text" x-model="formData.nama" @input="formData.nama = $event.target.value.toUpperCase()" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition shadow-sm" placeholder="Nama Lengkap">
                            <p x-show="errors.nama" x-text="errors.nama" class="text-[11px] text-red-500 italic font-bold"></p>
                            <p class="text-[11px] text-gray-500 italic text-left text-transform-none" style="text-transform: none;">* Silahkan ubah Nama jika anda mengajukan anggota lain dalam 1 KK Anda.</p>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <select
                                x-on:change="
                                    ...
                                    console.log('Pengambilan ID:', formData.pengambilan_id);
                                    console.log('Nama Pengambilan:', formData.nama_pengambilan);
                                " 
                                    ...
                                    <div class="space-y-2">
                                        <template x-if="getMapping()">
                                            <label 
                                                ...
                                                :class="formData.selectedLayanan.includes(getMapping().main.id.toString()) || formData.selectedLayanan.includes(getMapping().main.id) ? 'border-green-500 bg-green-50 ring-2 ring-green-100' : 'border-gray-100 bg-white hover:border-green-200'"
                                            >
                                                <div class="flex items-center">
                                                    <input type="checkbox" :value="getMapping().main.id" x-model="formData.selectedLayanan" class="w-5 h-5 accent-green-600 flex-shrink-0">
                                ...
                                <div class="space-y-1" x-show="getMapping() && (getMapping().includes.length > 0 || getMapping().note)">
                                    ...
                                    <div class="space-y-2" x-show="getMapping() && getMapping().includes.length > 0">
                                        <template x-for="item in (getMapping() ? getMapping().includes : [])" :key="item.id">
                                            <label 
                                                class="flex items-center justify-between p-2.5 border-2 rounded-xl cursor-pointer transition-all duration-200"
                                                :class="formData.selectedLayanan.includes(item.id.toString()) || formData.selectedLayanan.includes(item.id) ? 'border-green-500 bg-green-50 ring-2 ring-green-100' : 'border-gray-100 bg-white hover:border-green-200'"
                                            >
                                                <div class="flex items-center">
                                                    <input type="checkbox" :value="item.id" x-model="formData.selectedLayanan" class="w-5 h-5 accent-green-600 flex-shrink-0">
                        ...
                        <div class="md:col-span-2 space-y-1">
                            <!-- <label class="text-sm font-semibold text-gray-700">Keterangan Anda</label> -->
                ...
                <div x-show="currentStep === 3" class="space-y-4" 
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-3.5 rounded-r-xl shadow-sm mb-3">
                        <div class="flex items-start text-blue-800 mb-2">
                            <svg class="w-5 h-5 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            <div>
                                <h4 class="font-bold text-sm text-blue-900">Informasi Persyaratan Dokumen (Berkas ganda cukup diunggah sekali) :</h4>
                                <p class="text-[11px] text-blue-700 mt-0.5 font-semibold leading-relaxed">Silakan lengkapi berkas asli sesuai pilihan Anda di bawah. Jika terdapat berkas persyaratan yang sama di antara beberapa layanan, Anda cukup mengunggahnya satu kali saja.</p>
                            </div>
                        </div>

                        <div class="mt-2 space-y-2 sm:pl-7">
                            <template x-for="id in formData.selectedLayanan" :key="id">
                                <div class="bg-white/60 rounded-lg py-2 px-3 border border-blue-100/50 shadow-xs">
                                    <div class="font-bold text-xs text-blue-950 mb-0 flex items-center">
                                        <span class="w-2 h-2 rounded-full bg-blue-600 mr-2 flex-shrink-0"></span>
                                        <span x-text="getLayananNameById(id)"></span>
                                    </div>
                                    
                                    <!-- List Persyaratan -->
                                    <div class="text-[11px] text-gray-700 leading-relaxed pl-4 font-semibold">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <template x-for="(src, index) in previews.file" :key="index">
                                    <div class="relative w-28 h-28 rounded-lg overflow-hidden border shadow-sm">
                                        ...
                                        <button type="button" @click="removeFile('file', index)" class="absolute top-1 right-1 bg-red-500 text-white rounded-full p-1"><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M6 18L18 6M6 6l12 12" stroke-width="2"/></svg></button>
                                    </div>
                                </template>
                            </div>
                        </div>
                                ...
                                <div class="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-200 rounded-xl">
                                    ...
                                    <button type="button" onclick="openCameraModal()" class="flex flex-col items-center group">
                                        <div class="bg-gray-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-3 group-hover:bg-blue-50 transition">
                                            <svg class="w-8 h-8 text-gray-500 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div id="selfie-preview-container" class="mt-4 hidden">
                                        <div class="relative w-40 h-40 rounded-2xl overflow-hidden border-2 border-gray-200 shadow-lg group">
                                            ...
                                            <div class="absolute inset-0 bg-black/40 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button type="button" onclick="reviewFoto()" class="bg-white/20 p-2 rounded-full hover:bg-white/40 transition" title="Lihat Foto">
                                                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                                    </svg>
                                                </button>

                                                <button type="button" onclick="openCameraModal()" class="bg-white/20 p-2 rounded-full hover:bg-white/40 transition" title="Foto Ulang">
                                                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <button type="button" onclick="removeSelfie()" class="absolute top-1 left-1 bg-red-600 text-white rounded-full p-1 shadow-md">
                ...
                <div x-show="currentStep === 4" x-transition.opacity>
                    <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100 space-y-4">
                        ...
                        <div class="flex justify-between border-b pb-2 text-sm"><span class="text-gray-500">Keterangan :</span><span class="font-bold" x-text="formData.keterangan_user"></span></div>
                        <div class="flex justify-between border-b pb-2 text-sm"><span class="text-gray-500">Lampiran Berkas :</span><span class="text-green-600 font-bold" x-text="formData.file.length + ' File diunggah'"></span></div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 flex flex-col-reverse sm:flex-row justify-between items-center gap-3">
                    <button type="button" x-show="currentStep > 1" @click="prevStep" class="w-full sm:w-auto px-5 py-2 text-sm bg-gray-100 text-gray-600 font-semibold rounded-lg hover:bg-gray-200 transition">
                        Sebelumnya
                    </button>
                    <button type="button" x-show="currentStep < 4" @click="nextStep" class="w-full sm:w-auto ml-auto px-6 py-2 text-sm bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition active:scale-95">
                        Selanjutnya
                    </button>
                    <button id="submit-btn" type="button" x-show="currentStep === 4" @click="submitForm()" class="w-full sm:w-auto ml-auto px-6 py-2 text-sm bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition active:scale-95">
                        Kirim Permohonan
                    </button>
                </div>
            ...
            <p class="text-center text-gray-500 text-xs mt-6">© 2026 Pondok Dukcapil V-2.1.1 - Layanan Online</p>
    </div>
    <span x-effect="
        if (currentStep === 3) {
            setTimeout(() => {
